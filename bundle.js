...
var Toolbar = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  bottom: -50px;\n  left: 0;\n  right: 0;\n  height: 40px;\n  padding: 5px;\n  background: rgba(0, 0, 0, 0.6);\n  transition: 0.25s all;\n"], ["\n  position: absolute;\n  bottom: -50px;\n  left: 0;\n  right: 0;\n  height: 40px;\n  padding: 5px;\n  background: rgba(0, 0, 0, 0.6);\n  transition: 0.25s all;\n"])));
var YoutubeContainer = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: relative;\n\n  height: 320px;\n  width: 640px;\n\n  overflow: hidden;\n\n  iframe {\n    height: 100%;\n    width: 100%;\n  }\n\n  :hover {\n    ", " {\n      bottom: 0;\n    }\n  }\n"], ["\n  position: relative;\n\n  height: 320px;\n  width: 640px;\n\n  overflow: hidden;\n\n  iframe {\n    height: 100%;\n    width: 100%;\n  }\n\n  :hover {\n    ", " {\n      bottom: 0;\n    }\n  }\n"])), Toolbar);
var Button = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].button(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  cursor: pointer;\n  color: white;\n  border: 0;\n  padding: 0;\n  width: 40px;\n  height: 40px;\n  text-align: center;\n  line-height: 40px;\n  font-family: Verdana;\n  font-size: 12px;\n  background: none;\n  transition: 0.25s all;\n  vertical-align: middle;\n\n  &:hover {\n    color: red;\n  }\n"], ["\n  cursor: pointer;\n  color: white;\n  border: 0;\n  padding: 0;\n  width: 40px;\n  height: 40px;\n  text-align: center;\n  line-height: 40px;\n  font-family: Verdana;\n  font-size: 12px;\n  background: none;\n  transition: 0.25s all;\n  vertical-align: middle;\n\n  &:hover {\n    color: red;\n  }\n"])));
var VolumeButton = Object(__WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */])(Button)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  transform: scaleX(-1);\n  font-size: 20px;\n  position: relative;\n\n  ", "  \n"], ["\n  transform: scaleX(-1);\n  font-size: 20px;\n  position: relative;\n\n  ",
    "  \n"])), function (props) {
    if (props.muted) {
...
var Timer = __WEBPACK_IMPORTED_MODULE_3_styled_components__["a" /* default */].span(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: inline-block;\n  height: 40px;\n  line-height: 40px;\n  padding: 0 5px;\n  color: white;\n  vertical-align: middle;\n  position: relative;\n  top: 2px;\n  font-size: 13px;\n"], ["\n  display: inline-block;\n  height: 40px;\n  line-height: 40px;\n  padding: 0 5px;\n  color: white;\n  vertical-align: middle;\n  position: relative;\n  top: 2px;\n  font-size: 13px;\n"])));
var App = function () {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__src_index__["a" /* default */], { videoId: 'SKGzIhOSQVY', controls: 0, modestbranding: 0, showinfo: 0, rel: 0, render: function (_a) {
            var iframe = _a.iframe, playVideo = _a.playVideo, pauseVideo = _a.pauseVideo, getPlayerState = _a.getPlayerState, getCurrentTime = _a.getCurrentTime, getDuration = _a.getDuration, isMuted = _a.isMuted, mute = _a.mute, unMute = _a.unMute;
            var isPlaying = getPlayerState() === 1;
            ...
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](YoutubeContainer, null,
                iframe,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Toolbar, null,
                    !isPlaying && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Button, { onClick: function (event) { return playVideo(); } }, "\u25B6"),
                    isPlaying && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Button, { onClick: function (event) { return pauseVideo(); } }, "\u2590\u2590"),
                    isMuted() && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](VolumeButton, { muted: true, onClick: function (event) { return unMute(); } }, "\uD83D\uDD6A"),
                    !isMuted() && __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](VolumeButton, { onClick: function (event) { return mute(); } }, "\uD83D\uDD6A"),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Timer, null, formatTime(getCurrentTime()) + " / " + formatTime(getDuration())))));
        } }));
};
...
"use strict";
/* unused harmony export ListType */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
...
var YoutubePlayer = /** @class */ (function (_super) {
    ...
    function YoutubePlayer() {
        ...
        _this.callbackObject = {
            iframe: __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { id: _this.state.playerName }),
    ...
    YoutubePlayer.prototype.render = function () {
        if (!this.props.render) {
            return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { id: this.state.playerName });
        }
        else {
...
/* harmony default export */ __webpack_exports__["a"] = (YoutubePlayer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_hoist_non_react_statics__ = __webpack_require__(33);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27)(module)))
